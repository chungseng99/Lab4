...
public class ClientTextFrame extends JFrame {
	...
	private JLabel lblNumberOfText;
	 ...
	 */
	public void updateNumberOfText (int numberOfText) {
		
		
		this.lblNumberOfText.setText(Integer.toString(numberOfText));
	...
	private JPanel getServerDatePanel(Font font) {
		...
		JPanel panel = new JPanel();
		JLabel lblDate = new JLabel ("Number of text: ");
		

		// Style the component
		lblDate.setFont(font);
		lblNumberOfText.setFont(font);
		
		lblDate.setBackground(Color.WHITE);
		lblDate.setOpaque(true);
		lblNumberOfText.setBackground(Color.WHITE);
		lblNumberOfText.setOpaque(true);
		

		// Organize components into panel
		panel.add(lblDate);
		panel.add(lblNumberOfText);
